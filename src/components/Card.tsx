...
const Card: React.FC<ICard> = ({ item, text, handleFunc }) => {
  return (
    <div className="w-10/12 sm:w-6/12 md:w-4/12 lg:w-3/12 flex-col justify-between bg-zinc-200 rounded-lg">
      <div className="p-4 ">
      ...
      <div className="flex justify-between items-center bg-zinc-600 p-3 rounded-b-lg">
        <h2 className="text-slate-200 font-bold">€{item.price}</h2>
        <button
          className="text-slate-200 font-bold p-2 bg-slate-500 rounded-lg animate-pulse hover:animate-none"
